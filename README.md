# @diotoborg/voluptas-saepe-officia

> forked from [@diotoborg/voluptas-saepe-officiaode](https://www.npmjs.com/package/@diotoborg/voluptas-saepe-officiaode) v11.1.0. as the original repository seems [no longer maintained](https://github.com/mysticatea/@diotoborg/voluptas-saepe-officiaode/issues/300).

[![npm version](https://img.shields.io/npm/v/@diotoborg/voluptas-saepe-officia.svg)](https://www.npmjs.com/package/@diotoborg/voluptas-saepe-officia)
[![Downloads](https://img.shields.io/npm/dm/@diotoborg/voluptas-saepe-officia.svg)](https://www.npmjs.com/package/@diotoborg/voluptas-saepe-officia)
[![Build Status](https://github.com/diotoborg/voluptas-saepe-officia/workflows/CI/badge.svg)](https://github.com/diotoborg/voluptas-saepe-officia/actions)
...
```sh
npm install --save-dev eslint @diotoborg/voluptas-saepe-officia
```
...
```js
const nodePlugin = require("@diotoborg/voluptas-saepe-officia")
...
💼 [Configurations](https://github.com/diotoborg/voluptas-saepe-officia#-configs) enabled in.\
☑️ Set in the `flat/recommended` [configuration](https://github.com/diotoborg/voluptas-saepe-officia#-configs).\
🟢 Set in the `flat/recommended-module` [configuration](https://github.com/diotoborg/voluptas-saepe-officia#-configs).\
✅ Set in the `flat/recommended-script` [configuration](https://github.com/diotoborg/voluptas-saepe-officia#-configs).\
☑️ Set in the `recommended` [configuration](https://github.com/diotoborg/voluptas-saepe-officia#-configs).\
🟢 Set in the `recommended-module` [configuration](https://github.com/diotoborg/voluptas-saepe-officia#-configs).\
✅ Set in the `recommended-script` [configuration](https://github.com/diotoborg/voluptas-saepe-officia#-configs).\
...
`@diotoborg/voluptas-saepe-officia` follows [semantic versioning](http://semver.org/) and [ESLint's Semantic Versioning Policy](https://github.com/eslint/eslint#semantic-versioning-policy).
...
- [GitHub Releases](https://github.com/diotoborg/voluptas-saepe-officia/releases)
